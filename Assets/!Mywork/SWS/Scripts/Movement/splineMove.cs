...
namespace SWS
{
    ...
    public class splineMove : MonoBehaviour
    {
        ...
        void Start()
        {
            transform.LookAt(pathContainer.transform);
            //isface = false;  
        ...
        public void StartMove()
        {
            ...
            ////else
            ////{
            //pathContainer = GameObject.FindGameObjectWithTag("Player").transform.GetChild(2).gameObject.GetComponent<PathManager>();
            ////}
